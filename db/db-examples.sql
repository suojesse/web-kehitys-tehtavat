...
-- Inserting exercise entries
INSERT INTO Exercise (user_id, exercise_date, activity, duration_minutes, exercise_notes, created_at) VALUES
  (1, '2024-01-10', 'Running', 45, 'Felt good, nice weather', '2024-01-10 20:00:00'),
  (1, '2024-01-11', 'Gym', 60, 'Good workout, feeling strong', '2024-01-11 20:00:00'),
  (2, '2024-01-10', 'Yoga', 60, 'Relaxing, good for stress relief', '2024-01-10 21:00:00');
